...
Route::get('/api/post/category/{id}', [PostController::class, 'getPostsByCategory'])->name('api_post_getpostbycat');
Route::get('/api/post/user/{id}', [PostController::class, 'getPostsByUser'])->name('api_post_getpostbyuser');
